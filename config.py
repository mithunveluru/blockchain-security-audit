"""
Centralized configuration with environment-aware validation.
All runtime settings resolve here. Import this before any other app module.
"""
...
class Config:
    ...
    # Explicit opt-in for simulation mode. Without this, missing Scapy is a fatal error.
